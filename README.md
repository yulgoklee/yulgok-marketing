...
| **02. Performance** | 6 KPI + 차트 3종 + KPI Strip + Quality over Quantity + Retention Marketing + Lag Effect + 듀얼 채널 블로그 |
| **03. Strategy** | 운영 구조 컨텍스트 + 5가지 핵심 역량 + 마케팅 퍼널 |
| **04. Crisis Response & Decision** | 알고리즘 변경 (회복탄력성 -44%→-12%) + 카카오 비즈니스 손절 |
| **05. AI Pipeline** | 4단계 멀티 모델 워크플로우 + 산출물 블로그 링크 |
| **06. Contact** | 연락처 + 노션 이력서 링크 + Looking For 박스 |

## v3 주요 업데이트 (2026.05)

새 인사이트 4가지를 추가하여 데이터 깊이를 한 단계 끌어올렸습니다.

- **리드당 매출 +75%** (21만원 → 36만원) — 질적 성장
- **등록당 매출 +118%** (60만원 → 130만원) — 타겟팅 정교화
- **리텐션 매출 비중 14% → 39%** — LTV 향상의 정량 증거
- **콘텐츠 lag effect 상관계수 0.62** — 2개월 lag, 자산화 효과의 통계적 증명
- **회복탄력성 -44% → -12%** — 알고리즘 충격을 매출이 흡수한 정량 증거
